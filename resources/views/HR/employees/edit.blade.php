                ...
                <div data-uk-observe="" id="wizard_advanced" role="application" class="wizard clearfix">
                        ...
                        <section id="fill_form_section" role="tabpanel" aria-labelledby="fill form section" class="body step-0 current" data-step="0" aria-hidden="false"   v-bind:class="{'uk-hidden': in_payment_section} ">
                              ...
                              <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">First Name :</label><input type="text" id="fname" name="fname" class="md-input"   required="required"    value="{{  $employee->Name }}"   v-model="fname"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Last Name :</label><input type="text" id="surname" name="surname" class="md-input"   required="required"    value="{{ $employee->surname }}"   v-model="surname"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_skype">Other Names :</label><input type="text" id="oname" name="othernames" v-form-ctrl  class="md-input"   value="{{ $employee->othernames }}"  v-model="othernames"      /><span class="md-input-bar"></span></div>         
                               ...
                               <div class="parsley-row">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Phone N<u>o</u> :</label><input type="text" id="tel" name="phone" class="md-input" data-parsley-type="digits" minlength="10" value="{{$employee->phone}}"  required="required"   maxlength="10"   pattern='^[0-9]{10}$'  v-model="tel"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_twitter">Date of Birth :</label><input type="text" name="dob" class="md-input" data-uk-datepicker="{format:'DD/MM/YYYY'}" required="required" value="{!!  $employee->dob !!}"  v-model="dob"  v-form-ctrl   ><span class="md-input-bar"></span></div>
                          ...
                          <div class="parsley-row">
                            <div class="uk-input-group">
                                ...
                                <div class="md-input-wrapper md-input-filled">
                                  {!!   Form::select('country',$country,array("required"=>"required","class"=>"md-input","id"=>"country","v-model"=>"country","v-form-ctrl"=>"","style"=>"width: 226px;","v-select"=>"")   )  !!}
                                  </div> 
                    ...
                    <div class="parsley-row">
                        <div class="uk-input-group">
                            ...
                            <div class="md-input-wrapper md-input-filled"><label for="wizard_skype">Place of residence :</label><input type="text" id="residence" name="residence" v-form-ctrl  class="md-input"      v-model="residence"      /><span class="md-input-bar"></span></div>         
                    ...
                    <div class="uk-input-group">
                        ...
                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Contact Address :</label><input type="text" id="contact" name="contact" class="md-input"   required="required"    value="{{$employee->address}}"   v-model="contact"  v-form-ctrl><span class="md-input-bar"></span></div>                
                 ...
                 <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Hometown :</label><input type="text" id="hometown" name="hometown" class="md-input"   required="required"    value="{{$employee->hometown}}"   v-model="hometown"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Level of Education :</label><input type="text" id="education" name="education" class="md-input"   required="required"    value="{{ $employee->education }}"   v-model="education"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                 ...
                                 <div class="parsley-row">
                                     <div class="uk-input-group">
                                         ...
                                         <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Email :</label><input type="email" id="email" name="email" class="md-input"  value="{{$employee->email}}"  v-model="email"v-form-ctrl  ><span class="md-input-bar"></span></div>                                            
                                 ...
                                 <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">SSNIT :</label><input type="text" id="ssnit" name="ssnit" class="md-input"   required="required"    value="{{ $employee->ssnit }}"   v-model="ssnit"  v-form-ctrl><span class="md-input-bar"></span></div>                
                             ...
                             <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Dependents No :</label><input type="number" id="dependents" name="dependents" class="md-input"       value="{{ $employee->dependentsNo }}"   v-model="dependents"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Date Hired :</label><input type="text" id="hired" name="hired" class="md-input"  data-uk-datepicker="{format:'DD/MM/YYYY'}"    value="{{ $employee->dateHired}}"   v-model="hired"  v-form-ctrl><span class="md-input-bar"></span></div>                
                                 ...
                                 <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled"><label for="wizard_email">Position :</label><input type="text" id="position" name="position" class="md-input"   required="required"    value="{{$employee->position}}"   v-model="position"  v-form-ctrl><span class="md-input-bar"></span></div>                
               ...
               <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                     ...
                     <div class="parsley-row">
                            <div class="uk-input-group">
                                ...
                                <div class="md-input-wrapper md-input-filled">
                                  {!!   Form::select('department',$department ,array("required"=>"required","class"=>"md-input","id"=>"department","v-model"=>"department","v-form-ctrl"=>"","style"=>"width: 226px;","v-select"=>"{{old('department')}}")   )  !!}
                            <span class="md-input-bar"></span>
                                </div> 
                    ...
                    <div class="parsley-row">
                            <div class="uk-input-group">
                                ...
                                <div class="md-input-wrapper md-input-filled">
                                  {!!   Form::select('supervisor',$supervisor ,array("required"=>"required","class"=>"md-input","id"=>"supervisor","v-model"=>"supervisor","v-form-ctrl"=>"","style"=>"width: 226px;","v-select"=>"supervisor")   )  !!}
                            <span class="md-input-bar"></span>
                                </div> 
                    ...
                    <div class="parsley-row">
                            <div class="uk-input-group">
                                ...
                                <div class="md-input-wrapper md-input-filled">
                                  {!!   Form::select('designation',$designation ,array("required"=>"required","class"=>"md-input","id"=>"designation","v-model"=>"designation","v-form-ctrl"=>"","style"=>"width: 226px;","v-select"=>"designation")   )  !!}
                            <span class="md-input-bar"></span>
                                </div> 
                        ...
                        <div class="uk-width-1-1">
                            <div id="file_upload-drop" style="margin-left:0px" class="uk-file-upload">
                                ...
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 186px;">
                                   ...
                                   <img class="" style="width:180px;height: auto"  <?php   $pic=$employee->staffID; echo $obj->picture("{!! url(\"public/staffPics/$pic.jpg\") !!}",90)  ?>   src="<?php echo url("public/staffPics/$pic.jpg")  ?>" alt=" Picture of Employee Here"    /></a> 
...
var vm = new Vue({
 ...
 data : {
  ...
  contact : "{{  $employee->address }}",
  hometown : "{{  $employee->hometown }}",
  residence : "{{  $employee->placeofresidence }}",
