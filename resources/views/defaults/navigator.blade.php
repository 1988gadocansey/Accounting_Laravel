...
<!-- <li class=''><a target='main'  href="{{ url('gl_account_inquiry') }}" ><i class='fa fa-file-text'></i>  GL Accounts Inquiry </a></li>-->
                        ...
                        <div class="uk-accordion-content">
                            <p class="">
                                <span class="md-list-heading"><a target='main'  href="{{ url('add_departments') }}" ><i class='fa fa-plus-circle'></i>  Add Departments </a></span>
                            </p>
                            <p class="">
                                <span class="md-list-heading"><a target='main'  href="{{ url('view_departments') }}" ><i class='fa fa-file-text'></i>  View Departments </a></span>
                            </p>
                        ...
                        <div class="uk-accordion-content">
                            <p class="">
                                <span class="md-list-heading"><a target='main'  href="{{ url('add_employees') }}" ><i class='fa fa-plus-circle'></i>  Add Employees </a></span>
                            </p>
                            <p class="">
