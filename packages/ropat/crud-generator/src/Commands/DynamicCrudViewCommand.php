...
class DynamicCrudViewCommand extends Command {
	/**
	 * The name and signature of the console command.
	 *
	 * @var string
	 */
	public $signature = 'ropat-dynamic-crud:view
	 ...
	 * @var string
	 */
	public $description = 'Create views for the Crud.';
	 ...
	 * @return void
	 */
	public function wrapField($item, $field) {
		$formGroup =
			<<<EOD
...
EOD;
	 ...
	 * @return string
	 */
	public function createField($item) {
	 ...
	 * @return string
	 */
	public function createFormField($item) {
	 ...
	 * @return string
	 */
	public function createPasswordField($item) {
		$required = ($item['required'] === true) ? ", 'required' => 'required'" : "";
	 ...
	 * @return string
	 */
	public function createInputField($item) {
		$required = ($item['required'] === true) ? ", 'required' => 'required'" : "";
	 ...
	 * @return string
	 */
	public function createRadioField($item) {
		$field =
			<<<EOD
            <div class="checkbox">
